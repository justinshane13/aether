    ...
    return (
        <div className={styles.partners}>
            <div className={styles.partnersSection1}>
                ...
                <p><strong>Customers</strong>: if you are already working with someone to oversee and maintain your parking equipment, that's not a problem — we can work with anyone. We can add SPDPRK technology to your operation and will work closely with your existing partner. We will make sure they have the tools and information they need to maintain your equipment.</p>
            </div>
